...
export default function HealthBreedingPage() {
    ...
    return (
        <div className="space-y-6">
            {/* Page Header */}
            <div>
                <h1 className="text-4xl font-black tracking-tight text-slate-900 dark:text-white">Health & Breeding</h1>
                <p className="text-slate-600 dark:text-slate-400 mt-2 font-medium">Comprehensive cow health records, breeding lifecycle management, and automated action reminders.</p>
            </div>
